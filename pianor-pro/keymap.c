...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BaseL] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   LGUI_T(KC_A), LALT_T(KC_R),    LCTL_T(KC_S),    LSFT_T(KC_T),      KC_G,                                                             KC_M,             RSFT_T(KC_N),    LCTL_T(KC_E),    LALT_T(KC_I),    LGUI_T(KC_O),    KC_NO,
        KC_NO,   KC_Z,         KC_X,            KC_C,            KC_D,              KC_V,                                                             KC_K,             KC_H,            KC_COMM,         KC_DOT,          KC_SLSH,         KC_NO,
                                                                 LT(_McrL, KC_ESC), LT(_NavL, KC_SPC), LT(_ZroL, KC_TAB),         LT(_SymL, KC_ENT),  LT(_NumL, KC_BSPC), LT(_FunL, KC_DEL)
    ),
    [_NavL] = LAYOUT_split_3x6_3(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_NO,   KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                              KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RGHT, KC_NO,   
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    ...
    [_NumL] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   KC_GRV,  KC_1,    KC_2,    KC_3,    KC_SLSH,                            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    ...
    [_FunL] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_NO,                              KC_NO,   KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_NO,
        KC_NO,   KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                            KC_ESC,  KC_SPC, KC_TAB,            KC_NO,   KC_NO,   KC_NO
    ),
    [_McrL] = LAYOUT_split_3x6_3(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   MC_HELIX,KC_NO,
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                              KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case MC_HELIX:
        if (record->event.pressed) {
            ...
            SEND_STRING(SS_TAP(X_SPC)SS_TAP(X_QUOT)SS_TAP(X_UP)"q");
        } else {
